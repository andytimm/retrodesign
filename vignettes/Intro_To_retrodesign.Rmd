...
type_s_plot <- ggplot(effect_s_pairs, aes(possible_effects, type_s)) + geom_point()
type_m_plot <- ggplot(effect_m_pairs, aes(possible_effects, type_m)) + geom_point()

grid.arrange(type_s_plot, type_m_plot, ncol = 2)
```
...
For the majority of this vingette, I've avoided 
