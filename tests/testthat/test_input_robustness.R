...
context("Make sure functions respond correctly with negative,
        small, large, non-sensisical inputs")
...
test_that("type M error is always a positive ratio", {
  ...
  # but making it work explicitly in the package
